...
import type { ProductListModel } from "../../../domain/models/interfaces"
 ...
 * 
 * @param {ProductListModel} props - Component properties containing the products promise.
 */
export default function ProductList({ productsPromise }: ProductListModel) {
